...
检查以下用户消息是否包含违规内容。请特别注意区分**情绪宣泄**和**真实威胁**。

违规内容定义：
1.  **真实的暴力威胁**：明确表示要对他人或自己造成伤害，并有具体计划或意图。
2.  **色情内容**：露骨的性描述或邀请。
3.  **宣扬邪教或极端思想**。

**豁免情况（不视为违规）**：
*   **情绪化的暴力言论**：用户在表达愤怒、沮丧或痛苦时，使用了“想杀人”、“想死”等词语，但没有构成明确、具体的威胁。这通常是情绪的宣泄，而不是真实的意图。例如：“我气得想杀人”、“这工作让我痛苦得想死”。

基于以上标准，检查以下消息：
- 如果属于违规内容，返回 "VIOLATION"
- 如果不属于违规内容（包括情绪宣泄），返回 "OK"
